...
MA 02110-1301, USA. ''')
        	...
        	about.set_website("http://linuxliteos.com")
...
def get_info(info):
	...
	try:
		...
		if info=="netip": return execute("hostname --ip-address")
	except:
		return " "
...
This file generated by Lite Center on %s '''
...
def frontend_fill():
	...
	page=page.replace("{string_2}", ("This is a quick overview of your system.."))
	...
	page=page.replace("{string_13}", ("Host name: "))
	page=page.replace("{string_14}", ("Kernel: "))
	page=page.replace("{string_15}", ("UNUSED"))
	page=page.replace("{string_16}", ("Software & Packages"))
